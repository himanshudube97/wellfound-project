...
export const D3_FORMAT_OPTIONS = [
  ...
  [
    'INDIAN_ADAPTIVE_FORMAT',
    t('Indian Adaptive Format (12345678 => 1.23 Cr, 123456 => 1.23 L)'),
  ],
  [
    'INDIAN_ADAPTIVE_.1f_FORMAT',
    t('Indian Adaptive Format (12345678 => 1.2 Cr, 123456 => 1.2 L)'),
  ],
  [
    'INDIAN_NUMBER_FORMAT',
    t('Indian Number Format (12345678.8500001 =>  12,34,56,78.85)'),
  ],
  [
    'INDIAN_NUMBER_.1f_FORMAT',
    t('Indian Number Format (12345678.8500001 =>  12,34,56,78.9)'),
  ],
  [
    'INDIAN_ROUND_OFF_FORMAT',
    t('Indian Round Off Format (723.67 cr =>  724 cr)'),
  ],
];
